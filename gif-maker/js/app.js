(function () {
  "use strict";
  var mainbutton, pause, preset = [720, 480];
      ...
      if (confirm(facetogif.str.rusure)) {
        ...
        facetogif.upload({
          ...
          onuploaded: function (json) {
            ...
            var finalImage = 'http://imgur.com/' + e.target.href;
            
            window.open("https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2F" + finalImage);
